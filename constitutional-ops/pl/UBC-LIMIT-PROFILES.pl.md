...
| `wersja` | `0.1.0-draft` |
| `podstawa` | Art. XII.10-13 Konstytucji DIA; `UNIVERSAL-BASIC-COMPUTE.pl.md`; `FIP-MEMBERSHIP-AND-QUORUM.pl.md` |
...
- **Konstytucja Art. XII.10-13**: wyznacza granice nieodbieralnego minimum i
