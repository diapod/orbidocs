...
| `version` | 0.1.0-draft |
| `basis` | Art. VII.4-5, Art. XIV of the Constitution; `../core-values/CORE-VALUES.en.md` section "Reputation as Leverage, Not Power" |
...
The reputation mechanisms described in `../core-values/CORE-VALUES.en.md` -
...
reputation section of `../core-values/CORE-VALUES.en.md`:
...
- **`../core-values/CORE-VALUES.en.md` - "Reputation as Leverage, Not Power"**:
