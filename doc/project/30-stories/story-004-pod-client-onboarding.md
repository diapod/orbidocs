...
This story is the post-MVP `pod-client` counterpart of `story-001-swarm-node-onboarding.md`. It no longer
...
The main difference from `story-001-swarm-node-onboarding.md` is simple: the user's device stays thin and
