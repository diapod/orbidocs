...
| [Proposal 065: Local Relationship Layer](../40-proposals/065-local-relationship-layer.md) | `true` | `false` | `false` | `78` |
...
| [Local Relationship Layer](../60-solutions/032-local-relationship-layer/032-local-relationship-layer.md) | `true` | `false` | `false` | `78` |
