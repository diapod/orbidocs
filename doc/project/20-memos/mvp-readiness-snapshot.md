...
- Proposal 076 / Solution 041 / `federation-root.v1` is hard-MVP ready while remaining a
  ...
  events. The hard-MVP acceptance harness seeders now write explicit signed
