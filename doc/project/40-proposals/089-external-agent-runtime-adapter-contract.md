...
end-to-end inference execution provenance. The latter remains planned under
Proposal 090 and `P089-011`.
...
1. Freeze Proposal 090, then implement `P089-011` as an additive generic
