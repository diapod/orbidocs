...
translator inventory runs its named verification sets in CI. Post-dispatch
terminal errors, cache/replay identity, batch embedding, training, artifact
carriage, parent joins, response-contract successors, consumer policies, and the
complete cross-node provenance matrix remain implementation work. Existing locality policies,
