...
- **Bootstrap endorsement delivery:**
  ...
  than being downgraded per-entry. Node implements this schema/runtime slice;
  remaining P076-021 work is consumer-side per-use re-verification and broader
  official-service consumers.
