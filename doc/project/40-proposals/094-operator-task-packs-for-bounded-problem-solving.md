...
| `P094-002` | Freeze the qmail reference story and acceptance contract | `001` | `todo` | An accepted story names requester, solver, reviewer, thematic profile, prepared environment, bounded actions, mandatory HIL, verifier checks, rollback, refusal cases, and retained evidence without adding qmail branches to shared code. |
...
| `P094-013` | Run local acceptance | `010`, `011`, `012` | `todo` | Evidence covers clean install, conformance, activation, binding from defaults, operator-initiated deliberation, observation-first experiment, HIL mutation and denial, qmail verification, rollback, restart, pause/resume, profile-change blocking, and revocation. |
...
| `P094-016` | Run multi-node publication acceptance | `007`, `013` | `todo` | Evidence covers offer publication, requester discovery, remote deliberation, exact profile-digest admission by the provider, stale-offer refusal after revocation, and committed withdrawal. |
