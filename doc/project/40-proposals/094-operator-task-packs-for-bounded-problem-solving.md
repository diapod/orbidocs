...
- **M1 – inspect and dry-run.** `P094-002`, `P094-003a`, `P094-004a`, `P094-004b`, `P094-005a`, `P094-005b`, `P094-006`, and the read surfaces of
...
| `P094-005b` | Recompute pack facts at package conformance | `004b`, `005a` | `todo` | The package conformance run recomputes the pack facts of every task profile it binds from owner sources and records the result with the P085 conformance report; any difference to the authored profile or manifest fails conformance. |
