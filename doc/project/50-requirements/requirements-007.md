...
| FR-021bb | `gateway-policy.v1` MAY expose `fee/egress-basis-points`, but the first MVP SHOULD keep it `null` until the outbound payout path stabilizes. | Fact | Proposal 016 |
