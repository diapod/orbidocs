...
| `version` | 0.1.0-draft |
| `basis` | Art. VII.4-5, VII.6, VII.8, XI of the DIA Constitution; `REPUTATION-VALIDATION-PROTOCOL.en.md`; `ROOT-IDENTITY-AND-NYMS.en.md`; `doc/normative/30-core-values/en/CORE-VALUES.en.md` section "Reputation as Leverage, Not Power" |
