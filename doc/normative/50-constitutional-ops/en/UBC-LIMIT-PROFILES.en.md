...
| `version` | `0.1.0-draft` |
| `basis` | Art. XII.12-14 of the DIA Constitution; `UNIVERSAL-BASIC-COMPUTE.en.md`; `FIP-MEMBERSHIP-AND-QUORUM.en.md` |
...
- **Constitution Art. XII.12-14**: sets the bounds of the non-withdrawable floor
