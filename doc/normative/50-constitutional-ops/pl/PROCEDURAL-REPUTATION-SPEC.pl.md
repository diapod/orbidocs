...
| `wersja` | 0.1.0-draft |
| `podstawa` | Art. VII.4-5, VII.6, VII.8, XI Konstytucji DIA; `REPUTATION-VALIDATION-PROTOCOL.pl.md`; `ROOT-IDENTITY-AND-NYMS.pl.md`; `doc/normative/30-core-values/pl/CORE-VALUES.pl.md` sekcja "Reputacja jako dźwignia, nie władza" |
