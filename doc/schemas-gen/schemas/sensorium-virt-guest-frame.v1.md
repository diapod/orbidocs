...
| [`operation/kind`](#field-operation-kind) | `no` | enum: `spawn-process`, `open-pty`, `terminal-input`, `terminal-read`, `terminal-resize`, `terminal-signal`, `file-snapshot`, `file-read`, `patch-stage`, `artifact-export`, `inspect`, `quiesce`, `shutdown` |  |
...
- Required: `no`
- Shape: enum: `spawn-process`, `open-pty`, `terminal-input`, `terminal-read`, `terminal-resize`, `terminal-signal`, `file-snapshot`, `file-read`, `patch-stage`, `artifact-export`, `inspect`, `quiesce`, `shutdown`
