...
Source schema: [`doc/schemas/corpus-reasoning-room-policy.v3.schema.json`](../../schemas/corpus-reasoning-room-policy.v3.schema.json)

Corpus Room policy binding Chair controls and the requester's exact signed extension posture, federated envelope, and required semantic entries.
...
| [`extension-binding`](#field-extension-binding) | `yes` | object |  |
