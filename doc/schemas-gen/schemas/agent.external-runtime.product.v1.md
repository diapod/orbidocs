...
Source schema: [`doc/schemas/agent.external-runtime.product.v1.schema.json`](../../schemas/agent.external-runtime.product.v1.schema.json)

## Fields

| Field | Required | Shape | Description |
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `agent.external-runtime.product.v1` |  |
...
| [`producer/snapshot`](#field-producer-snapshot) | `yes` | ref: `#/$defs/ref` |  |
| [`budget/used`](#field-budget-used) | `yes` | ref: `#/$defs/usage-value` |  |
...
- Required: `yes`
- Shape: const: `agent.external-runtime.product.v1`
...
<a id="field-producer-snapshot"></a>
## `producer/snapshot`
