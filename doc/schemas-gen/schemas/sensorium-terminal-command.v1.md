...
Source schema: [`doc/schemas/sensorium-terminal-command.v1.schema.json`](../../schemas/sensorium-terminal-command.v1.schema.json)
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `sensorium-terminal-command.v1` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `1` |  |
| [`command/id`](#field-command-id) | `yes` | ref: `#/$defs/ref` |  |
| [`terminal.session/ref`](#field-terminal-session-ref) | `yes` | ref: `#/$defs/ref` |  |
| [`intent`](#field-intent) | `yes` | ref: `sensorium-command-intent.v1.schema.json` |  |
| [`normalized-argv/sha256`](#field-normalized-argv-sha256) | `yes` | string |  |
...
<a id="field-normalized-argv-sha256"></a>
