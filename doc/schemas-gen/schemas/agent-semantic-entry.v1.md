...
Source schema: [`doc/schemas/agent-semantic-entry.v1.schema.json`](../../schemas/agent-semantic-entry.v1.schema.json)

Domain-owned code-backed Agent consumer, output sink, or effect-policy adapter entry.
...
| [`constraints`](#field-constraints) | `yes` | unspecified |  |
