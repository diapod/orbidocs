# Configuration Change Plan Response v1

Source schema: [`doc/schemas/config-change.plan.response.v1.schema.json`](../../schemas/config-change.plan.response.v1.schema.json)
