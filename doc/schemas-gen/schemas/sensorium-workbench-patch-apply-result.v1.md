...
Source schema: [`doc/schemas/sensorium-workbench-patch-apply-result.v1.schema.json`](../../schemas/sensorium-workbench-patch-apply-result.v1.schema.json)

Applied or rejected patch result with changed file digests and refusal diagnostics.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `sensorium-workbench-patch-apply-result.v1` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `1` |  |
| [`patch/ref`](#field-patch-ref) | `yes` | ref: `#/$defs/ref` |  |
| [`result/ref`](#field-result-ref) | `yes` | ref: `#/$defs/ref` |  |
| [`status`](#field-status) | `yes` | enum: `applied`, `rejected`, `failed` |  |
| [`changed`](#field-changed) | `yes` | array |  |
...
- Required: `yes`
- Shape: const: `sensorium-workbench-patch-apply-result.v1`
...
- Required: `yes`
- Shape: enum: `applied`, `rejected`, `failed`

<a id="field-changed"></a>
## `changed`
