# Agent Inference Passage Product v2

Source schema: [`doc/schemas/agent.inference-passage-product.v2.schema.json`](../../schemas/agent.inference-passage-product.v2.schema.json)

Compatible successor binding one V1 Agent inference product to the joined provider-neutral provenance of its current execution and inherited Agent products.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `agent.inference-passage-product.v2` |  |
...
- Required: `yes`
- Shape: const: `agent.inference-passage-product.v2`
