...
Source schema: [`doc/schemas/corpus-semantic-entry.v1.schema.json`](../../schemas/corpus-semantic-entry.v1.schema.json)

Domain-owned code-backed Corpus role-policy or instruction-overlay entry.
