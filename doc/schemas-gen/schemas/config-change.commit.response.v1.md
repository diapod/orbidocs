# Configuration Change Commit Response v1

Source schema: [`doc/schemas/config-change.commit.response.v1.schema.json`](../../schemas/config-change.commit.response.v1.schema.json)
