# Semantic Dispatch Classification v1

Source schema: [`doc/schemas/dispatch-classification.v1.schema.json`](../../schemas/dispatch-classification.v1.schema.json)

Reviewed classification of one structurally discovered semantic dispatch anchor.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `dispatch-classification.v1` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `1` |  |
| [`subject/ref`](#field-subject-ref) | `yes` | ref: `#/$defs/identifier` |  |
| [`domain`](#field-domain) | `yes` | ref: `#/$defs/identifier` |  |
| [`anchor/name`](#field-anchor-name) | `yes` | ref: `#/$defs/identifier` |  |
...
| [`branch/keys`](#field-branch-keys) | `yes` | ref: `#/$defs/refs` |  |
...
- Required: `yes`
- Shape: const: `dispatch-classification.v1`
