# Configuration Setting Descriptor v1

Source schema: [`doc/schemas/config-setting-descriptor.v1.schema.json`](../../schemas/config-setting-descriptor.v1.schema.json)
