# Story 012 Critique-gated Power DNS Full-system Report v1

Source schema: [`doc/schemas/story-012-powerdns-critique-gated-full-system-report.v1.schema.json`](../../schemas/story-012-powerdns-critique-gated-full-system-report.v1.schema.json)

Closed metadata-only report for the Story 012 single-host critique-gated PowerDNS and Bielik full-system acceptance.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `story-012-powerdns-critique-gated-full-system-report.v1` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `1` |  |
| [`status`](#field-status) | `yes` | const: `passed` |  |
| [`profile/id`](#field-profile-id) | `yes` | const: `story-012-powerdns-bielik-critique-gated-vfkit` |  |
...
- Required: `yes`
- Shape: const: `story-012-powerdns-critique-gated-full-system-report.v1`
...
- Required: `yes`
- Shape: const: `story-012-powerdns-bielik-critique-gated-vfkit`
