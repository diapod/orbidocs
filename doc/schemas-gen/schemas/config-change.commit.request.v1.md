# Configuration Change Commit Request v1

Source schema: [`doc/schemas/config-change.commit.request.v1.schema.json`](../../schemas/config-change.commit.request.v1.schema.json)
