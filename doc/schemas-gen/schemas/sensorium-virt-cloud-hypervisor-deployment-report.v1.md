# Sensorium Virt Cloud-hypervisor Deployment Report v1

Source schema: [`doc/schemas/sensorium-virt-cloud-hypervisor-deployment-report.v1.schema.json`](../../schemas/sensorium-virt-cloud-hypervisor-deployment-report.v1.schema.json)

Closed, metadata-only evidence report for one real cloud-hypervisor full-system deployment run.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `sensorium-virt-cloud-hypervisor-deployment-report.v1` |  |
...
- Required: `yes`
- Shape: const: `sensorium-virt-cloud-hypervisor-deployment-report.v1`
