# Configuration Change Plan Request v1

Source schema: [`doc/schemas/config-change.plan.request.v1.schema.json`](../../schemas/config-change.plan.request.v1.schema.json)
