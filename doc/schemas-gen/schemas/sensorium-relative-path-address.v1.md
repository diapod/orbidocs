...
Source schema: [`doc/schemas/sensorium-relative-path-address.v1.schema.json`](../../schemas/sensorium-relative-path-address.v1.schema.json)
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `sensorium-relative-path-address.v1` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `1` |  |
| [`workspace/ref`](#field-workspace-ref) | `yes` | ref: `#/$defs/ref` |  |
| [`root/ref`](#field-root-ref) | `yes` | ref: `#/$defs/ref` |  |
| [`relative/path`](#field-relative-path) | `yes` | string | A relative path string. The exact `.` may name the allowlisted root; concrete operations may still reject root self-access. |
