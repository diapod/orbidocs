...
Source schema: [`doc/schemas/room-live-message.v4.schema.json`](../../schemas/room-live-message.v4.schema.json)

Signed inference assertion carrier. Removing or replacing its assertion cannot become a replay of the same message.
