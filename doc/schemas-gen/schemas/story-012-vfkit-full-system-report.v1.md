# Story 012 Vfkit Full-system Vertical Report v1

Source schema: [`doc/schemas/story-012-vfkit-full-system-report.v1.schema.json`](../../schemas/story-012-vfkit-full-system-report.v1.schema.json)

Closed evidence report for the Story 012 single-runtime vfkit full-system vertical.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `story-012-vfkit-full-system-report.v1` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `1` |  |
| [`status`](#field-status) | `yes` | const: `passed` |  |
| [`profile/id`](#field-profile-id) | `yes` | const: `story-012-vfkit-full-system` |  |
...
- Required: `yes`
- Shape: const: `story-012-vfkit-full-system-report.v1`
...
- Required: `yes`
- Shape: const: `story-012-vfkit-full-system`
