# Story 012 Power DNS Discovery MLX Full-system Report v2

Source schema: [`doc/schemas/story-012-powerdns-discovery-full-system-report.v2.schema.json`](../../schemas/story-012-powerdns-discovery-full-system-report.v2.schema.json)

Closed metadata-only report proving that two pinned Qwen2.5-Coder MLX runtimes authored and reviewed PowerDNS changes under the existing host-owned Story 012 authority boundary, with exact package lifecycle and resource-calibration evidence and no llama-server fallback.
...
|---|---|---|---|
| [`schema`](#field-schema) | `yes` | const: `story-012-powerdns-discovery-full-system-report.v2` |  |
| [`schema/v`](#field-schema-v) | `yes` | const: `2` |  |
| [`status`](#field-status) | `yes` | const: `passed` |  |
| [`profile/id`](#field-profile-id) | `yes` | const: `story-012-powerdns-qwen25-coder-discovery-mlx-vfkit` |  |
...
| [`mlx-lifecycle-measurements`](#def-mlx-lifecycle-measurements) | object |  |
| [`mlx-resource-calibration`](#def-mlx-resource-calibration) | object |  |
## Field Semantics
...
- Required: `yes`
- Shape: const: `story-012-powerdns-discovery-full-system-report.v2`
...
- Required: `yes`
- Shape: const: `story-012-powerdns-qwen25-coder-discovery-mlx-vfkit`
...
<a id="def-mlx-lifecycle-measurements"></a>
## `$defs.mlx-lifecycle-measurements`

- Shape: object

<a id="def-mlx-resource-calibration"></a>
## `$defs.mlx-resource-calibration`
