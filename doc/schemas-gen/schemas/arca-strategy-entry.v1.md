...
Source schema: [`doc/schemas/arca-strategy-entry.v1.schema.json`](../../schemas/arca-strategy-entry.v1.schema.json)

Domain-owned code-backed Arca selection, fan-in, or fulfillment strategy entry.
